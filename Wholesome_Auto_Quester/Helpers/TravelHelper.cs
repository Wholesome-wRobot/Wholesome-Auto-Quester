...
namespace Wholesome_Auto_Quester.Helpers
{
    ...
    public class TravelHelper
    {
        ...
        private static List<ModelWorldMapArea> _worldMapAreas;
        public static List<ModelWorldMapArea> WorlMapAreas
        {
            get
            {
                if (_worldMapAreas == null)
                {
                    DB _dataBase = new DB();
                    _worldMapAreas = _dataBase.QueryWorldMapAreas();
                    _dataBase.Dispose();
                }
                return _worldMapAreas;
            }
        }
        ...
        public static ModelWorldMapArea GetWorldMapAreaFromPoint(Vector3 position, int mapdId) // return real continent enum later
        {
            ...
            foreach (ModelWorldMapArea wma in WorlMapAreas)
            {
        ...
        public static bool NeedToTravelTo(WAQTask task)
        {
        ...
        public static bool ShouldTakeZeppelinTirisfalToStranglethorn(ModelWorldMapArea myWMArea, WAQTask task)
        {
        ...
        public static bool ShouldTakeZeppelinStranglethornToTirisfal(ModelWorldMapArea myWMArea, WAQTask task)
        {
            return myWMArea.Continent == WAQContinent.EasternKingdoms
        ...
        static readonly int zeppelinTirisfalToStranglethornId = 176495;

        static readonly Vector3 tirisfalPlatformZepStranglethorn = new Vector3(2057.805, 242.4949, 99.76875, "None");
        static readonly Vector3 insideZeppelinTirisfalToStranglethorn = new Vector3(2056.706, 231.9014, 100.0376, "None");

        static readonly Vector3 stranglethornPlatformZepTirisfal = new Vector3(-12415.1, 207.7803, 31.49846, "None");
        static readonly Vector3 insideZeppelinStranglethornToTirisfal = new Vector3(-12401.24, 206.9413, 32.03218, "None");
        ...
        static readonly Vector3 orgrimmarPlatformZepTirisfal = new Vector3(1324.798, -4652.622, 53.78583);
        static readonly Vector3 insideZeppelinKalimdorToTirisfal = new Vector3(1312.742, -4653.958, 54.14745);
        ...
        //Ships
        static readonly Vector3 bayRatchetToBootyBay = new Vector3(-993.4946, -3825.295, 5.689055, "None");
        static readonly Vector3 insideShipRatchetToBootyBay = new Vector3(-998.897, -3835.783, 6.215654, "None");

        static readonly Vector3 bayBootyBayToRatchet = new Vector3(-14285.3, 556.2886, 8.837771, "None");
        static readonly Vector3 insideShipBootyBayToRatchet = new Vector3(-14276.39, 575.9086, 6.084363, "None");
        ...
        /*
        static readonly Vector3 bayMenethilToHowlingFjord = new Vector3(-3724.361, -583.2341, 4.74352, "None");
        static readonly Vector3 insideShipMenethilToHowlingFjord = new Vector3(-3711.364, -573.7974, 9.489109, "None");

        static readonly Vector3 bayHowlingFjordToMenethil = new Vector3(591.8311, -5099.395, 5.260396, "None");
        static readonly Vector3 insideShipHowlingFjordToMenethil = new Vector3(588.0685, -5120.662, 9.447546, "None");
        ...
        static readonly Vector3 shattrathPortalToOrgrimmarPosition = new Vector3(-1934.205f, 5452.766f, -12.42705f);
        ...
        // ********** FROM OUTLANDS **********
        public static void PortalShattrathToDarnassus()
        {
        ...
        public static void ZeppelinKalimdorToTirisfal()
        {
            Logger.Log("Taking zeppelin to Tirisfal");
        ...
        public static void ZeppelinOrgrimmarToNorthrend()
        {
        ...
        private static void WaitOnTransport(Vector3 arrivalPoint, int distance)
        {
        ...
        private static void ForceMoveTo(Vector3 destination)
        {
